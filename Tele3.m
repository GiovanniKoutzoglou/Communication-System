...
fprintf('bits: %d \n', bits);
fprintf('\n');
encodedData = convenc(bits,trellis);
fprintf('\n');
fprintf('Encoded data: %d \n', encodedData);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                         "M-PAM Modulation"                          %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

symbols = pammod(encodedData,M);
fprintf('\n');
fprintf('symbols: %d \n', symbols);
...
receiveBits = pamdemod(receiveSym,M);
fprintf('\n');
...
vitoutput = vitdec(receiveBits,trellis,tbl,'trunc','hard');
fprintf('\n');
fprintf('viterbi output: %d \n', vitoutput);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                          "Error Rate"                               %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

error = bits ~= vitoutput;
sum_error = sum(error);
...
% Receiver bits plot
figure;
stem(vitoutput,':','markerfacecolor','black')
title('Viterbi output');
grid on;
set(gca,'ylim',[-1.5 1.5])
